...
rivers = {
    'Aliakmonas': [[40.4500, 22.6000], [40.5333, 21.7000], [40.2833, 21.1833], 'Longest river entirely in Greece'],
    'Achelous': [[38.3333, 21.1000], [39.1500, 21.3833], [39.8167, 21.1833], 'Sacred river in ancient Greece'],
    'Pinios': [[39.8667, 22.7000], [39.7500, 22.2000], [39.6333, 21.6333], 'Main river of Thessaly'],
    'Evros': [[40.7833, 26.0333], [41.2833, 26.3333], [41.7167, 26.3333], 'Forms natural border with Turkey'],
    'Strymonas': [[41.0833, 23.8500], [41.2833, 23.3333], [41.0833, 23.1333], 'Important river in Macedonia']
}
