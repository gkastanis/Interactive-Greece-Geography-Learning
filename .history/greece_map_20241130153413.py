...
var mountain_group = L.featureGroup()
var lake_group = L.featureGroup()
var river_group = L.featureGroup()

# Add feature groups to map after it's initialized
document.addEventListener('DOMContentLoaded', function() {
    mountain_group.addTo(map);
    lake_group.addTo(map);
    river_group.addTo(map);
});
...
<script>
    ...
    function showCategorySelection() {
        var mountain_group = L.featureGroup().addTo(map);
        var lake_group = L.featureGroup().addTo(map);
        var river_group = L.featureGroup().addTo(map);
